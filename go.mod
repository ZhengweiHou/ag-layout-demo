module ag-layout-demo

go 1.24.8

require (
	gitlab.allinfinance.com/aifgo/ag-core v0.9.19
	gitlab.allinfinance.com/aifgo/ag-core/contribute/agdb v0.9.19
	gitlab.allinfinance.com/aifgo/ag-core/contribute/aghertz v0.9.19
	gitlab.allinfinance.com/aifgo/ag-core/contribute/agkitex v0.9.19
	gitlab.allinfinance.com/aifgo/ag-core/contribute/agnacos v0.9.19
